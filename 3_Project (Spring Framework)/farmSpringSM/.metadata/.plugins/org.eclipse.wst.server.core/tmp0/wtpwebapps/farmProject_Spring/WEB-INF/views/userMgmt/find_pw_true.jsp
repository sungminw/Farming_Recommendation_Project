...
<!--       <a href="recomend.do" class="nav-item nav-link">추천서비스</a> -->
    ...
    <div class="container-fluid header_img py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5">
            <h1 class="display-3 text-white mb-4 animated slideInDown">비밀번호 확인</h1>
        </div>
    </div>
    <!--Header Moving Picture End-->

    <main class="container" id="content">
      <div class="find_id_title">${name }님의 비밀번호</div>
      <div class="find_box">
        <div class="find_name_box input_box_design">
          <label for="find_name">&nbsp;&nbsp;비밀번호&nbsp;&nbsp;&nbsp;&nbsp;</label>
          <span>${pw}</span>        
        </div>
      </div>
        <div class="pw_button">
            <button type="button" name="submit_button" id="submit_button"><a href="login.do">로그인</a></button>
        </div>
    </main>
...
<!--         <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">커뮤니티</a> -->
<!--         <div class="dropdown-menu bg-light m-0"> -->
<!--           <a href="serviceEsidence.do" class="dropdown-item">농지 & 거주지 현황</a> -->
<!--           <a href="festival.do" class="dropdown-item">지역축제 & 문화행사</a> -->
<!--           <a href="success.do" class="dropdown-item">귀농 성공사례</a> -->
<!--         </div> -->
<!--       </div> -->
<!--       <a href="login.do" class="nav-item nav-link">로그인</a> -->
<!--       <a href="joinMember.do" class="nav-item nav-link">회원가입</a> -->
<!--       <a href="login.do" class="nav-item nav-link" style="display: none">로그아웃</a> -->
<!--       <a href="joinMember.do" class="nav-item nav-link" style="display: none">마이페이지</a> -->
<!--     </div> -->
<!--   </div> -->
<!-- </nav> -->
<!--     Navbar End -->
...
<!--     <div class="container-fluid header_img py-5 mb-5 wow fadeIn" data-wow-delay="0.1s"> -->
<!--         <div class="container text-center py-5"> -->
<!--             <h1 class="display-3 text-white mb-4 animated slideInDown">비밀번호 재설정</h1> -->
<!--         </div> -->
<!--     </div> -->
<!--     Header Moving Picture End -->
...
<!--           <input type="password" name="pw_input" id="pw_input" class="width_200" placeholder="새로운 비밀번호 입력" autocomplete="off"> -->
<!--         </div> -->

<!--         <div class="pw_input_check_box input_box_design"> -->
<!--           <label for="pw_input_check">비밀번호 확인&nbsp;&nbsp;</label> -->
<!--           <input type="password" name="pw_input_check" id="pw_input_check" class="width_200" placeholder="비밀번호 확인" autocomplete="off"> -->
<!--         </div> -->

<!--         <div class="pw_button"> -->
<!--             <button type="submit" name="submit_button" id="submit_button"><a href="login.html">Setting</a></button> -->
<!--         </div> -->
<!--       </form> -->
