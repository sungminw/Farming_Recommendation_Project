<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="com.farm.myapp.userMgmt.model.*" %>
...
<!--       <a href="recomend.do" class="nav-item nav-link">추천서비스</a> -->
    ...
    <div class="container-fluid header_img py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5">
            <h2 class="display-3 text-white mb-4 animated slideInDown">회원 정보 수정</h2>
        </div>
    </div>
    <!--Header Moving Picture End-->

    <main class="container">
    <form action="modifyService.do" method="post" name="modifyForm">
       <div class="content row">
        <div class="member_info_box offset-md-3 col-md-6 col-sm-12">
          ...
          <div id="member_pw" class="member_box_design">비밀번호 : <input type="password" name="pw" value="${memberInfo.pw }"></div>
          <div id="member_pw_check" class="member_box_design">비밀번호 확인: <input type="password" name="pw_check" value="${memberInfo.pw }" style="width: 180px"></div>
          <div id="member_name" class="member_box_design">이름 : ${memberInfo.name }</div>
          <div id="member_address" class="member_box_design">주소 : <input type="text" name="address" value="${memberInfo.address }"></div>
          <div id="member_email" class="member_box_design">이메일 : <input type="email" name="eMail" value="${memberInfo.eMail }"></div>
          <div id="member_birth" class="member_box_design">생년월일 : ${memberInfo.ssn }</div>
          <div id="member_update_button_box">
          	<input type="button" value="취소 하기" class="my_button" onclick="updateInfoReset()">
          	<input type="button" value="수정 하기" class="my_button" onclick="updateInfoConfirm()">
<!--           <div id="correction_btn"><a href="pwCheck.do">수정 하기</a></div> -->
        </div>
       </div>
      </div>
    </form>
