...
<!--     <script src="<%= contextPath %>/resources/lib/lightbox/js/chart.js"></script> -->
    <!-- Template Stylesheet -->
    <link href="<%= contextPath %>/resources/css/serviceSales1.css" rel="stylesheet">
...
<%-- 	<jsp:include page="header.jsp"></jsp:include> --%>
    ...
    <!-- Service Start -->
    <form  action="serviceCostGo.do" method="post" name="formR1">
            ...
            <div class="row gy-5 gx-3 inner_content">
                ...
                <c:forEach items="${cropList}" var="crop">
                	<div class="form-check py-1">
                  		<input class="form-check-input btn-crop" type="radio" name="flexRadioDefault" value="${crop.cropEng}">
                  		<label class="form-check-label" for="flexRadioDefault1">${crop.cropName }</label>  
                	</div>
               	</c:forEach>
...
<!--               농작물 매출                          -->
            ...
            <div class="modal-footer">
              <div class="hPrice_element">※ 경매단가 분석은 10a(300평)기준이며 최근 5년간의 농수산물유통정보의 도매 가격 데이터를 기준으로 제공 합니다.</div>
              </div>
          </div>
      </div>
      </div>
...
<!--               농작물 매출                          -->
            ...
            <div class="modal-footer">
              <div class="yield_element">※ 생산량 분석은 10a(300평)기준이며 최근 5년간의 통계청의 생산량 데이터를 기준으로 제공 합니다.</div>
              </div>
          </div>
      </div>
      </div>
...
<!-- 			<input type="hidden" class="selectCropKor" name="selectCropKor" value=""> -->
			<input type="hidden" class="areaEng" name="areaEng" value="">
         	<input type="hidden" class="salesResult" name="salesResult" value="">
            <button type="button" id="total_sales_submit">비용 분석</button>
          </div>
        </div>
      </div>
    </div>
...
<!-- </div> -->
  ...
  <!-- Copyright End -->
    ...
    <!-- Template Javascript -->
    <script src="<%= contextPath %>/resources/js/serviceSales1.js"></script>
    <script src="<%= contextPath %>/resources/js/userMgmt.js"></script>
<!--     <script src="<%= contextPath %>/resources/js/revenueChart.js"></script> -->
