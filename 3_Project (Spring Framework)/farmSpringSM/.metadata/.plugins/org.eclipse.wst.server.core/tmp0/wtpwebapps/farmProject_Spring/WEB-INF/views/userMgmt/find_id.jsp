...
<!--       <a href="recomend.do" class="nav-item nav-link">추천서비스</a> -->
    ...
    <main class="container" id="content">
      <div class="find_id_title">찾으실 아이디의 이름과 전화번호를 입력 하시오.</div>
      <form class="find_box" action="findIdService.do" name="findIdForm">
        <div class="find_name_box input_box_design">
          <!-- col-sm-offset-3 col-sm-6 col-sm-offset-3 col-xs-12 -->
          <label for="find_name">&nbsp;&nbsp;&nbsp;이름&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
          <input type="text" name="name" id="find_name" class="width_200" placeholder="ex)홍길동" autocomplete="off">
        </div>
        <div class="find_tel_box input_box_design">
          <label for="find_ssn">주민등록번호&nbsp;</label>
          <input type="text" name="ssn" id="find_ssn" class="width_200" placeholder="주민등록번호 앞 6자리를 입력 하세요" autocomplete="off">
        </div>
        <div class="find_button">
            <button type="button" name="submit_button" id="submit_button" onclick="findIdBoard()">검색</button>
        </div>
      </form>
    ...
    <!-- Template Javascript -->
    <script src="<%= contextPath %>/resources/js/find_id.js"></script>
