...
<!--       <a href="recomend.do" class="nav-item nav-link">추천서비스</a> -->
    ...
    <main class="container-xxl py-5">
    	...
    	<table class="board_list" width=100%>
			...
			<tr>
				<td class="fx wider-column">번호</td>
				<td>${content_view.bId }</td>
			</tr>
			<tr>
				<td class="fx wider-column">조회수</td>
				<td>${content_view.bHit }</td>
			</tr>
			<tr>
				<td class="fx wider-column">이름</td>
				<td>${content_view.bName }</td>
			</tr>
			<tr>
				<td class="fx wider-column">제목</td>
				<td>${content_view.bTitle }</td>
			</tr>
			<tr>
				<td class="fx wider-column">내용</td>
				<td>${content_view.bContent }</td>
			</tr>
			<tr class="bottom">
				<td colspan="2"><a href="modifyBoard.do?bId=${content_view.bId }">[수정]</a>&nbsp;&nbsp; <a href="delete.do?bId=${content_view.bId }">[삭제]</a>&nbsp;&nbsp; <a href="reply_view.do?bId=${content_view.bId }">[댓글]</a>&nbsp;&nbsp; <a href="list.do">[취소]</a></td>
			</tr>
	</table>
