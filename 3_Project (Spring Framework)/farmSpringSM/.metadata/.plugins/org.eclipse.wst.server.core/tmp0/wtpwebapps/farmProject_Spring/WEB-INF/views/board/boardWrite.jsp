...
<!--       <a href="recomend.do" class="nav-item nav-link">추천서비스</a> -->
    ...
    <main class="container-xxl py-5">
    	...
    	<table class="board_list" width=100%>
			<tr>
				<td class="fx">이름</td>
				<td><input type="text" class="input_text" name="bName" size="50"></td>
			</tr>
			<tr>
				<td class="fx">제목</td>
				<td><input type="text" class="input_text" name="bTitle" size="50"></td>
			</tr>
			<tr>
				<td class="fx">내용</td>
				<td><textarea class="input_text text_area" name="bContent" cols="50" rows="10"></textarea></td>
			</tr>
			<tr class="bottom">
				<td colspan="2"><input type="button" value="[입력]" class="writeSubmit" onclick="writeBoard()">&nbsp;&nbsp; <a href="list.do">[취소]&nbsp;&nbsp;</a></td>
			</tr>
		</form>
	</table>
