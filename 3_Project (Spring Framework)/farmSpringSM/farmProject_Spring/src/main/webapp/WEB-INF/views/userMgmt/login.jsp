...
<!--       <a href="recomend.do" class="nav-item nav-link">추천서비스</a> -->
    ...
    <main class="container" id="content">
      <form class="login_box" action="loginService.do" method="post" name="loginForm">
        <div class="login_id_box input_box_design">
          <!-- col-sm-offset-3 col-sm-6 col-sm-offset-3 col-xs-12 -->
          <label for="login_id">아이디&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
          <input type="text" name="id" id="login_id" placeholder="ID를 입력 하세요" autocomplete="off" value="">
        </div>
        ...
        <div class="login_button">
          <!-- <label for="submit_button"> -->
            <button type="button" name="submit_button" id="submit_button" onclick="loginEmpty()">로그인</button>
          <!-- </label> -->
        </div>
      </form>
      ...
      <div class="service_box">
        <div class="find_id border_right padding_10">
          <a href="find_id.do">ID찾기</a>
        </div> 
        <div class="find_pw border_right padding_10">
          <a href="find_pw.do">PW찾기</a>
        </div>
