                        ...
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-lg-8 text-start">
                                    ...
                                    <a href="serviceSales1.do" class="btn btn-secondary rounded-pill py-3 px-5 animated slideInRight">농작물 선택</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="container">
                            <div class="row justify-content-end">
                                <div class="col-lg-8 text-end">
                                    ...
                                    <h1 class="display-1 text-white mb-5 animated slideInRight">Welcome to  Jeonnam!</h1>
                                    <a href="serviceSales2.do" class="btn btn-secondary rounded-pill py-3 px-5 animated slideInLeft">지역 선택</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="container">
                            <div class="row justify-content-end">
                                <div class="col-lg-8 text-end">
                                    ...
                                    <h1 class="display-1 text-white mb-5 animated slideInRight">Welcome to  Jeonnam!</h1>
                                    <a href="serviceCost.do" class="btn btn-secondary rounded-pill py-3 px-5 animated slideInLeft">비용 분석</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="container">
                            <div class="row justify-content-end">
                                <div class="col-lg-8 text-end">
                                    ...
                                    <h1 class="display-1 text-white mb-5 animated slideInRight">Welcome to  Jeonnam!</h1>
                                    <a href="serviceProfit.do" class="btn btn-secondary rounded-pill py-3 px-5 animated slideInLeft">수익 조회</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row g-5 align-items-end">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <a class="btn btn-secondary rounded-pill py-3 px-5" href="serviceSales1.do">Explore More</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            ...
            <div class="row gy-5 gx-4">
                <div class="col-lg-3 col-md-6 pt-5 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item d-flex h-100">
                        <div class="service-img">
                            <img class="img-fluid" src="<%= contextPath %>/resources/img/index_sales.jpg" alt="">
                        </div>
                        <div class="service-text p-5 pt-0">
                            <div class="service-icon">
                                <img class="img-fluid rounded-circle" src="<%= contextPath %>/resources/img/index_sales.jpg" alt="" style="height: -webkit-fill-available;">
                            </div>
                            <h5 class="mb-3">매출 확인</h4>
                            <p class="mb-4">당신이 선호하는 지역과 농작물의 매출을 확인해보세요.</p>
                            <a class="btn btn-square rounded-circle" href="serviceSales1.do"><i class="bi bi-chevron-double-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 pt-5 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item d-flex h-100">
                        <div class="service-img">
                            <img class="img-fluid" src="<%= contextPath %>/resources/img/index_cost.jpg" alt="">
                        </div>
                        <div class="service-text p-5 pt-0">
                            <div class="service-icon">
                                <img class="img-fluid rounded-circle" src="<%= contextPath %>/resources/img/index_cost.jpg" alt="" style="height: -webkit-fill-available;">
                            </div>
                            <h5 class="mb-3">비용 확인</h4>
                            <p class="mb-4">농작물별 소요비용과 정부 정책 지원을 검색 한 소요비용을 분석해 보세요.</p>
                            <a class="btn btn-square rounded-circle" href="serviceCost.do"><i class="bi bi-chevron-double-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 pt-5 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item d-flex h-100">
                        <div class="service-img">
                            <img class="img-fluid" src="<%= contextPath %>/resources/img/index_profit.jpg" alt="">
                        </div>
                        <div class="service-text p-5 pt-0">
                            <div class="service-icon">
                                <img class="img-fluid rounded-circle" src="<%= contextPath %>/resources/img/index_profit.jpg" alt="" style="height: -webkit-fill-available;">
                            </div>
                            <h5 class="mb-3">수익 확인</h5>
                            <p class="mb-4">농작물 매출과 귀농시 필요한 초기 비용, 운영 비용을 종합한 수익을 확인해보세요.</p>
                            <a class="btn btn-square rounded-circle" href="serviceProfit.do"><i class="bi bi-chevron-double-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 pt-5 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item d-flex h-100">
                        <div class="service-img">
                            <img class="img-fluid" src="<%= contextPath %>/resources/img/index_policy.jpg" alt="">
                        </div>
                        <div class="service-text p-5 pt-0">
                            <div class="service-icon">
                                <img class="img-fluid rounded-circle" src="<%= contextPath %>/resources/img/index_policy.jpg" alt="" style="height: -webkit-fill-available;">
                            </div>
                            <h5 class="mb-3">정부지원 정책 확인</h5>
                            <p class="mb-4">지자체별 정부지원 정책을 확인해보세요.</p>
                            <a class="btn btn-square rounded-circle" href="servicePolicyCheck.do"><i class="bi bi-chevron-double-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6 pt-5 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item d-flex h-100">
                        ...
                        <div class="service-text p-5 pt-0">
                            ...
                            <a class="btn btn-square rounded-circle" href="festival.do"><i class="bi bi-chevron-double-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 pt-5 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item d-flex h-100">
                        ...
                        <div class="service-text p-5 pt-0">
                            ...
                            <a class="btn btn-square rounded-circle" href="success.do"><i class="bi bi-chevron-double-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
