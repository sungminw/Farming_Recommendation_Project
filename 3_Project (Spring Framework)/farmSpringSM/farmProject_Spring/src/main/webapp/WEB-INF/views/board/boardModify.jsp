...
<!--       <a href="recomend.do" class="nav-item nav-link">추천서비스</a> -->
    ...
    <main class="container-xxl py-5">
		...
		<form action="modify.do" method="post" name="modifyForm">
			...
			<tr>
				<td class="fx">제목</td>
				<td><input type="text" class="input_text" name="bTitle" value="${content_view.bTitle }"></td>
			</tr>
			<tr>
				<td class="fx">내용</td>
				<td><textarea class="input_text text_area" rows="10" name="bContent">${content_view.bContent }</textarea></td>
			</tr>
			<tr class="bottom">
				<td colspan="2"><input type="button" class="modifySubmit" value="[수정완료]" onclick="modifyBoard()">&nbsp;&nbsp; <a href="list.do">[취소]</a>&nbsp;&nbsp;</td>
			</tr>
		</form>
	</table>
