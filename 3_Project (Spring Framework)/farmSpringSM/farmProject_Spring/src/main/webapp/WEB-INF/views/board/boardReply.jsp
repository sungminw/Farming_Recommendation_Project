...
<!--       <a href="recomend.do" class="nav-item nav-link">추천서비스</a> -->
    ...
    <div class="container-fluid header_img py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
      <div class="container text-center py-5">
          <h1 class="display-3 text-white mb-4 animated slideInDown">귀농 성공사례</h1>
      </div>
  </div>

    <div class="text-center mx-auto pb-4 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
      <p class="section-title bg-white text-center text-primary px-3">Success Story</p>
    ...
    <main class="container-xxl py-5">
    	...
    	<table class="board_list" width=100%>
		<form action="reply.do" method="post" name="replyForm">
			<input type="hidden" name="bId" value="${reply_view.bId }"><!-- hidden은 화면에는 보이지 않지만 form tag에 값을 지정해 놓음 -->
			...
			<tr>
				<td class="fx">이름</td>
				<td><input type="text" class="input_text" name="bName" value=""></td>
			</tr>
			<tr>
				<td class="fx">제목</td>
				<td><input type="text" class="input_text" name="bTitle" value=""></td>
			</tr>
			<tr>
				<td class="fx">내용</td>
				<td><textarea class="input_text text_area" rows="10" name="bContent"></textarea></td>
			</tr>
			<tr class="bottom">
				<td colspan="2"><input type="button" value="[댓글입력]" class="replySubmit" onclick="replyBoard()">&nbsp;&nbsp; <a href="list.do">[취소]</a></td>
			</tr>
		</form>
	</table>
