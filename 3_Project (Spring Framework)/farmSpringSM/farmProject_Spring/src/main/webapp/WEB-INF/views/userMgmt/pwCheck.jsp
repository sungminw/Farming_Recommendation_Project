...
<!--       <a href="recomend.do" class="nav-item nav-link">추천서비스</a> -->
    ...
    <div class="container-fluid header_img py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5">
            <h1 class="display-3 text-white mb-4 animated slideInDown">본인 확인</h1>
        </div>
    </div>
    ...
    <main class="container-xxl">
      <div class="pw_content">
        <form class="pw_check_form" action="modify.do">
          <div class="pw_check_title">본인 확인을 위해 비밀번호를 입력 하시오</div>
          <input type="hidden" name="id" id="login_id"autocomplete="off" value="${id}">
          <div class="pw_check_box input_box_design">
            <label for="pw_check">비밀번호&nbsp;&nbsp;&nbsp;</label>
            <input type="password" name="pw" id="pw_check" placeholder="PW를 입력 하세요" autocomplete="off">
          </div>
          <div class="login_button">
            <button type="submit" name="submit_button" id="submit_button">확인</button>
            <!-- <button type="submit" name="submit_button" id="submit_button"><a href="mypage.html">확인</a></button> -->
          </div>
        </form>
      </div>
    </main>
    ...
    <!-- Template Javascript -->
    <script src="<%= contextPath %>/resources/js/pwCheck.js"></script>
