...
<!--       <a href="recomend.do" class="nav-item nav-link">추천서비스</a> -->
    ...
    <div class="container-fluid header_img py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5">
            <h1 class="display-3 text-white mb-4 animated slideInDown">회원 가입</h1>
        </div>
    </div>
    <!--Header Moving Picture End-->

    <main class="container" id="content">
      <form class="login_box" name="loginForm" action="joinService.do" method="post">
        <div class="login_id_box input_box_design">
          <!-- col-sm-offset-3 col-sm-6 col-sm-offset-3 col-xs-12 -->
          <label for="login_id">&nbsp;&nbsp;아이디&nbsp;&nbsp;&nbsp;</label>
          <input type="text" name="id" id="login_id" placeholder="ID를 입력 하세요" autocomplete="off">
        </div>
        <div class="login_pw_box input_box_design">
          <label for="login_pw">비밀번호&nbsp;&nbsp;</label>
          <input type="password" name="pw" id="login_pw" placeholder="PW를 입력 하세요" autocomplete="off">
        </div>
        
        <div class="login_pw_box input_box_design">
          <label for="login_pw_check">비밀번호 확인&nbsp;</label>
          <input type="password" name="pwCheck" id="login_pw_check" placeholder="PW를 한번 더 입력 하세요" autocomplete="off">
        </div>

        <div class="login_email_box input_box_design">
          <label for="login_email">이메일&nbsp;&nbsp;&nbsp;</label>
          <input type="email" name="eMail" id="login_email" placeholder="Email을 입력 하세요" autocomplete="off">
        </div>

        <div class="login_name_box input_box_design">
          <label for="login_name">이름&nbsp;&nbsp;&nbsp;</label>
          <input type="text" name="name" id="name" placeholder="이름를 입력 하세요" autocomplete="off">
        </div>

        <div class="login_birth_box input_box_design">
          <label for="login_ssn">주민등록번호&nbsp;</label>
          <input type="text" name="ssn" id="login_ssn" placeholder="주민등록번호 앞 6자리를 입력 하세요" autocomplete="off">
        </div>
        
        <div class="login_birth_box input_box_design">
          <label for="login_address">주소&nbsp;&nbsp;&nbsp;</label>
          <input type="text" name="address" id="login_address" placeholder="주소를 입력 하세요" autocomplete="off">
        </div>

<!--         <div class="login_tel_box input_box_design"> -->
<!--           <label for="login_tel">전화번호&nbsp;&nbsp;</label> -->
<!--           <input type="tel" name="login_tel" id="login_tel" placeholder="전화번호를 입력 하세요 ex)010-1234-5678" autocomplete="off"> -->
<!--         </div> -->

        <div class="tow_button">
          <button type="button" name="cancel_button" id="cancel_button" onclick="joinCancel()">취소</button>
          <button type="button" name="submit_button" id="submit_button" onclick="infoConfirm()">회원 가입</button>
        </div>
      </form>
