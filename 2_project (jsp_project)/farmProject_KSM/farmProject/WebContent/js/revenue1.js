...
//			    dataType: "json",
			    success: function(response) {
			    	...
			    	hPrice_draw(revenueArr, selectCrop_kor);
...
//경매 단가 차트 그리기
function hPrice_draw(revenueArr, selectCrop_kor) {
let hPrice = [];
...
//		    dataType: "json",
		    success: function(response) {
		    	...
		    	yield_draw(revenueArr, selectCrop_kor);
		    },
		    error: function() {
		      console.log("getCropHpriceYield 서버 요청 실패");
		    }
...
//생산량 차트 그리기
function yield_draw(revenueArr, selectCrop_kor) {
let yield_arr = [];
