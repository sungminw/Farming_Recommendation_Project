...
<head>
    ...
    <!-- mine -->
    <link rel="stylesheet" href="../css/revenue2.css" />
    <link href="../css/chart2.css" rel="stylesheet" />
...
<!--               농작물 매출                          -->
            ...
            <form action="serviceCost.jsp">
            	...
            	<button type="submit" class="btn btn-default btn-sm submit_cost">비용 분석</button>
            </form>
