...
<!-- 페이지 네이션 해야함 -->
    ...
    <!-- Page Submit Start -->
    <form id="total_cost" class="border_default mt-5">
      <div class="total_cost_inner row">
        ...
        <input type="hidden" name="policyCost" class="policyCost" value="">
        <input type="hidden" name="operCost" class="operCost" value="">
